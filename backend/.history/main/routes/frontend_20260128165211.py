...
@frontend_bp.route('/P-REGISTER.html')
def register_page():
    """
    注册页面
    """
    try:
        return send_from_directory(FRONTEND_DIR, 'P-REGISTER.html')
    except Exception as e:
        logger.error(f"❌ 加载注册页失败: {str(e)}")
        abort(404)
...
def static_files(filename):
    ...
    # 排除已定义的路由
    excluded_files = [
        'P-LOGIN.html', 'P-REGISTER.html', 'P-CHAT.html', 'P-HOME.html', 
