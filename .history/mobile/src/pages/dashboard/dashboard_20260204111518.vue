<template>
  <view class="dashboard-container" :style="{ backgroundColor: containerBgColor }">
    ...
    <!-- 血糖曲线模块 -->
    <GlucoseCurveChart canvas-id="glucoseCurveCanvas" />

    <!-- 添加记录按钮（仅≥12岁和家属） -->
    <view v-if="canAddRecord" class="add-record-btn" @tap="showAddRecordModal">
      <text class="add-icon">+</text>
      <text class="add-text">记录血糖</text>
    </view>

    <!-- 添加记录弹窗 -->
    <AddGlucoseRecord :visible="addRecordVisible" @close="addRecordVisible = false" />
